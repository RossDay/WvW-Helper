    ...
    public partial class Form1 : Form
    {
        ...
        private void mumbleTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (Manager.maybeUpdateStats())
            {
                ...
                builder.Append(", ");
                builder.Append(Manager.WvwStats.LeftMapWorldName);
                builder.Append(" = ");
                builder.Append(match.Scores.Get(Manager.WvwStats.LeftTeam));
                builder.Append(", ");
                builder.Append(Manager.WvwStats.RightMapWorldName);
                builder.Append(" = ");
                ...
                builder.AppendFormat("{0}: KDR = {1} ({2} / {3}), Last10 = {4}, Last30 = {5}\n", Manager.WvwStats.LeftMapWorldName, match.GetKDR(Manager.WvwStats.LeftTeam, map), match.GetKillsFor(Manager.WvwStats.LeftTeam, map), match.GetDeathsFor(Manager.WvwStats.LeftTeam, map), match.GetDeltaKDR(delta10, Manager.WvwStats.LeftTeam, map), match.GetDeltaKDR(delta30, Manager.WvwStats.LeftTeam, map));
                builder.AppendFormat("{0}: KDR = {1} ({2} / {3}), Last10 = {4}, Last30 = {5}\n", Manager.WvwStats.RightMapWorldName, match.GetKDR(Manager.WvwStats.RightTeam, map), match.GetKillsFor(Manager.WvwStats.RightTeam, map), match.GetDeathsFor(Manager.WvwStats.RightTeam, map), match.GetDeltaKDR(delta10, Manager.WvwStats.RightTeam, map), match.GetDeltaKDR(delta30, Manager.WvwStats.RightTeam, map));
                builder.AppendLine();
